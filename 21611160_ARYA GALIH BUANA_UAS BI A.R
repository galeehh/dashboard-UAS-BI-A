...
# Define UI
ui <- navbarPage(
  title = "Dashboard Southeast Asian E-Commerce",
  ...
  tabPanel("Multiple Linear Regresion",
           fluidPage(
             ...
             mainPanel(
               style = "margin: 0 auto; text-align: center; margin-left: 150px;",
  ...
  tabPanel("Prediction Dashboard",
           fluidPage(
             ...
             sidebarLayout(
               sidebarPanel(
                 numericInput("x1_input", "X1 (Number of Website Visitors per Month) :", value = 0),
                 numericInput("x2_input", "X2 (Number of Monthly Transactions) :", value = 12000),
                 numericInput("x3_input", "X3 (Average Number of Items per Transaction) :", value = 0),
                 numericInput("x4_input", "X4 (Customer Satisfaction Rating (scale 1–10)) :", value = 0),
                 numericInput("x5_input", "X5 (Number of Online Advertisements Run per Month) :", value = 22500),
